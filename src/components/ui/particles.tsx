...
export const Particles: React.FC<ParticlesProps> = ({
	...
	const animate = useCallback(() => {
		...
		// Remove circles after iteration (in reverse order to maintain correct indices)
		for (let i = circlesToRemove.length - 1; i >= 0; i--) {
			circles.current.splice(circlesToRemove[i], 1);
