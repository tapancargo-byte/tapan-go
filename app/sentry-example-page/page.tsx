    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://tapan-associate.sentry.io/issues/?project=4510506877911120">Issues Page</a>.
        ...
        <button
          ...
          onClick={async () => {
            ...
            await Sentry.startSpan(
              {
                op: "ui.click",
                name: "sentry-example-page: Throw Sample Error Button",
              },
              async (span) => {
                span.setAttribute("button.label", "Throw Sample Error");
                ...
                await Sentry.startSpan(
                  ...
                  async () => {
                    ...
                    if (!res.ok) {
                      ...
                      logger.warn(
                        logger.fmt`Sentry example API returned non-OK status: ${res.status}`,
                      );
                    }
                  },
                );
