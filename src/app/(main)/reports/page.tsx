	...
	useEffect(() => {
		...
		async function loadWarehouseDistribution() {
			...
			try {
				...
				const buckets: { Imphal: number; Delhi: number } = {
					Imphal: 0,
					Delhi: 0,
				};
	...
	return (
		<DashboardLayout
			header={{
				...
				description:
					"View comprehensive logistics performance metrics and business intelligence",
				icon: ProcessorIcon,
			}}
		>
					...
					<TabsContent value="revenue" className="space-y-4">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Monthly revenue and shipment volume
								</CardDescription>
							</CardHeader>
							<CardContent>
								<ChartContainer
					...
					<TabsContent value="warehouse" className="space-y-4">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Cargo distribution across warehouses
								</CardDescription>
							</CardHeader>
							<CardContent>
								{loadingWarehouse ? (
					...
					<TabsContent value="performance" className="space-y-4">
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Weekly on-time vs delayed shipments
								</CardDescription>
							</CardHeader>
							<CardContent>
								<ChartContainer
