						...
						<div className="space-y-2">
							...
							<div className="grid grid-cols-3 gap-2 text-xs">
								...
								<div className="text-center p-2 rounded bg-success/10 text-success-foreground">
									<div className="font-semibold">
										{mockMetrics.shipments.delivered}
									</div>
				...
				<CardPremium variant="elevated" className="col-span-2">
					...
					<CardContentPremium>
						<div className="space-y-4">
							{[
								{
									action: "Shipment #SH-2024-001 delivered",
									time: "2 minutes ago",
									status: "success",
								},
								{
								...
								{
									action: "Warehouse capacity alert",
									time: "1 hour ago",
									status: "warning",
								},
								{
									action: "Invoice #INV-2024-156 paid",
									time: "2 hours ago",
									status: "success",
								},
							].map((activity, index) => (
					...
					<CardContentPremium>
						<div className="space-y-3">
							<ButtonPremium
								...
								size="sm"
							>
								<span className="mr-2" role="img" aria-label="package">
									📦
								</span>
								Create Shipment
							</ButtonPremium>
							<ButtonPremium
								...
								size="sm"
							>
								<span className="mr-2" role="img" aria-label="people">
									👥
								</span>
								Add Customer
							</ButtonPremium>
							<ButtonPremium
								...
								size="sm"
							>
								<span className="mr-2" role="img" aria-label="chart">
									📊
								</span>
								Generate Report
							</ButtonPremium>
