...
} from "@/components/layout/use-tapan-associate-chat";
								...
								<div className="flex flex-col items-center justify-center h-full text-center space-y-6 pb-20">
									...
									<div className="space-y-2 max-w-md">
										...
										<p className="text-sm text-muted-foreground">
											I can analyze your shipments, help with invoices, or
											summarize operational risks based on your current
											dashboard context.
										</p>
									</div>
							...
							<div className="flex items-start gap-3">
								...
								<div className="space-y-1">
									...
									<p className="text-xs text-muted-foreground leading-relaxed">
										Tapan Associate can read the context of the page you came
										from. Try navigating to a shipment page and asking "What's
										wrong with this?"
									</p>
								</div>
							</div>
