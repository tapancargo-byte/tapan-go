		...
		<div className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden selection:bg-primary/20 selection:text-primary">
			...
			>
				...
				<div className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 lg:px-12 relative z-10">
					{/* Logo */}
					<UnifiedLogo onClick={handleLogoClick} />
			...
			<main className="flex flex-col pt-24">
				...
				>
					...
					>
						<Badge
							variant="outline"
							className="px-4 py-2 text-sm font-medium border-primary/20 bg-primary/5 text-primary rounded-full w-fit flex items-center gap-2"
						>
							<span className="relative flex h-2 w-2">
								<span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-primary opacity-75"></span>
								<span className="relative inline-flex rounded-full h-2 w-2 bg-primary"></span>
							</span>
							New Delhi <span className="mx-2 text-muted-foreground/50">|</span>{" "}
							Imphal
						</Badge>
						...
						<p className="text-lg md:text-xl text-muted-foreground max-w-lg leading-relaxed border-l-4 border-primary/20 pl-6">
							Your dedicated logistics partner connecting the Capital{" "}
							<strong>(New Delhi)</strong> to the Heart of Manipur{" "}
							<strong>(Imphal)</strong>. Fast, Secure, and Reliable since 2012.
						</p>
					...
					>
						<div className="absolute inset-0 bg-primary/20 blur-[100px] rounded-full opacity-60 pointer-events-none" />
						<Card className="relative z-10 w-full max-w-2xl overflow-hidden border-primary/20 bg-background/50 backdrop-blur-xl shadow-2xl shadow-primary/10 group">
							<div className="absolute inset-0 bg-gradient-to-tr from-primary/10 via-transparent to-transparent opacity-50" />
							<CardContent className="p-0 relative">
								<Lottie
									animationData={heroAnimation}
									loop={true}
									className="w-full h-auto transform scale-105 group-hover:scale-110 transition-transform duration-700"
								/>
							</CardContent>
						</Card>
					</MotionDiv>
					...
					<div className="container max-w-7xl mx-auto px-6">
						<div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
							<h2 className="text-4xl font-bold tracking-tight">
								Services Built for Manipur
							</h2>
							<p className="text-lg text-muted-foreground">
								We understand the unique logistics challenges of the Northeast.
							</p>
						</div>

						<div className="grid md:grid-cols-2 gap-8 lg:gap-12">
							{/* Air Cargo */}
							<Card className="relative hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group overflow-hidden bg-card">
								...
								<CardHeader className="relative z-10">
									...
									<CardTitle className="text-4xl font-display tracking-tight">
										Air Cargo
									</CardTitle>
								...
								<CardContent className="space-y-8 relative z-10">
									<p className="text-muted-foreground text-lg leading-relaxed font-light">
										The lifeline for urgent shipments. Medicines, documents,
										perishables, and high-value electronics moved securely from
										Delhi to Imphal.
									</p>
							...
							<Card className="relative hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group overflow-hidden bg-card">
								<div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-20 transition-opacity duration-500">
									<Truck className="w-48 h-48 text-primary blur-2xl" />
								</div>
								<CardHeader className="relative z-10">
									...
									<CardDescription className="text-lg font-medium">
										Heavy & Bulk Transport
									</CardDescription>
								</CardHeader>
								<CardContent className="space-y-8 relative z-10">
									<p className="text-muted-foreground text-lg leading-relaxed font-light">
										Cost-effective road transport solutions for bulk goods,
										household shifting, and commercial inventory.
									</p>
									<div className="grid grid-cols-2 gap-4">
										<div className="flex gap-2 items-center text-sm font-medium">
						...
						<div className="relative rounded-[2.5rem] overflow-hidden border border-border bg-card shadow-2xl p-8 lg:p-16 text-center ring-1 ring-border/50">
							...
							<div className="relative z-10 space-y-8">
								...
								<div className="max-w-xl mx-auto flex gap-2">
									...
									<Button size="xl" className="h-14 px-8 rounded-xl font-bold">
										Track
									</Button>
								</div>
							</div>
					...
					<div className="container max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16">
						<div className="space-y-8">
							...
							<p className="text-xl text-muted-foreground">
								Visit our offices for booking or inquiries.
							</p>
							...
							<div className="grid sm:grid-cols-2 gap-6">
								...
								<Card className="hover:border-primary/50 transition-colors">
									...
									<CardContent className="text-sm text-muted-foreground space-y-2 leading-relaxed">
										...
										<div className="pt-4 font-semibold text-foreground">
											+91 98561 23456
										</div>
									</CardContent>
								</Card>
								...
								<CardContent className="space-y-4">
									<div className="grid grid-cols-2 gap-4">
										<div className="space-y-2">
											<label htmlFor="quote-name" className="text-sm font-medium">Name</label>
											<Input id="quote-name" placeholder="Your Name" />
										</div>
										<div className="space-y-2">
											<label htmlFor="quote-phone" className="text-sm font-medium">Phone</label>
											<Input id="quote-phone" placeholder="+91..." />
										</div>
									</div>
									<div className="space-y-2">
										<label htmlFor="quote-city" className="text-sm font-medium">Pickup City</label>
										<Input id="quote-city" placeholder="e.g. New Delhi" />
									</div>
									<div className="space-y-2">
										<label htmlFor="quote-message" className="text-sm font-medium">Message</label>
										<textarea
											id="quote-message"
				...
				<div className="container max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
					<div className="text-center md:text-left">
						...
						<div className="text-sm text-muted-foreground mt-2">
							© {new Date().getFullYear()} Tapan Associate Cargo. <br /> All
							rights reserved.
						</div>
					</div>
			...
			<div className="fixed bottom-6 right-6 z-50">
				<div
					className={`transition-all duration-300 origin-bottom-right ${isChatOpen ? "opacity-100 scale-100" : "opacity-0 scale-95 pointer-events-none"}`}
				>
					{isChatOpen && (
						<AiAssistantCard
							className="h-[500px] w-[350px] rounded-2xl border bg-background shadow-2xl mb-4"
							wrapCloseButton={(button: any) =>
								cloneElement(button, { onClick: () => setIsChatOpen(false) })
							}
						/>
					)}
				</div>
				...
				<div className="relative group">
					...
					<Button
						size="icon"
						className="h-16 w-16 rounded-full shadow-2xl bg-primary text-primary-foreground hover:shadow-primary/50 hover:scale-110 transition-all duration-300 border-4 border-background/50"
					...
					{/* Notification Dot */}
					{!isChatOpen && (
						<span className="absolute top-0 right-0 h-4 w-4 bg-destructive border-2 border-background rounded-full animate-bounce" />
					)}
				</div>
			</div>
		</div >
