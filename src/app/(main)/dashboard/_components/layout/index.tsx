...
export default function DashboardPageLayout({
	...
	return (
		<div
			className={cn(
				"flex flex-col relative w-full gap-1 min-h-full",
				className,
			)}
		>
			{/* Page Header */}
			<div className="flex items-center lg:items-baseline gap-3 md:gap-4 px-4 md:px-6 py-4 md:pb-5 lg:pt-8 ring-1 ring-border/50 sticky top-header-mobile lg:top-0 bg-background/95 backdrop-blur-sm z-10 print:hidden">
				<div className="max-lg:contents bg-primary/10 size-8 md:size-10 flex items-center justify-center my-auto">
					<header.icon className="ml-1 lg:ml-0 text-primary size-5 md:size-6" />
				</div>
