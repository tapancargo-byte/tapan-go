...
export function SectionHeader({
	...
	return (
		<div className={cn("flex flex-col", alignStyles[align], className)}>
			{label && (
				<span
					className={cn(
			...
			>
				{icon && <span className="text-brand flex-shrink-0">{icon}</span>}
				{title}
			</h2>
			{subtitle && (
				<p className={cn("text-muted-foreground", styles.subtitle)}>
					{subtitle}
				</p>
			)}
		</div>
