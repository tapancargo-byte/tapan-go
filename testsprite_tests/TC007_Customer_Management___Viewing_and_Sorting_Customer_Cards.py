...
async def run_test():
    ...
    try:
        ...
        # Input the email for customer service user.
        ...
        frame = context.pages[-1]
        # Input the password for customer service user.
        ...
        frame = context.pages[-1]
        # Correct the email for customer service user.
        elem = frame.locator('xpath=html/body/div/main/div/section[2]/div/form/div/input').nth(0)
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Customer Revenue Summary').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: The test plan execution failed to validate the display of customer cards with activity metrics, shipment count, revenue data, and sorting functionality as expected.")
