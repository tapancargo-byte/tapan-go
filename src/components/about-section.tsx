...
const milestones = [
	{
		year: "2010",
		event: "Founded in Imphal with a vision to transform logistics",
	},
	{ year: "2015", event: "Expanded operations to cover all Northeast states" },
	{
		year: "2018",
		event: "Launched real-time tracking and digital documentation",
	},
			...
			<div className="max-w-7xl mx-auto px-6">
				...
				<div className="text-center mb-16">
					...
					<p className="text-muted-foreground max-w-2xl mx-auto">
						For over 15 years, Tapan Associate Cargo has been at the forefront
						of logistics innovation, connecting businesses across the globe with
						reliable, technology-driven cargo solutions.
					</p>
				</div>
				...
				<div className="grid lg:grid-cols-2 gap-12 mb-20">
					...
					<div className="bg-card rounded-2xl p-8 border border-border">
						...
						<div className="space-y-4 text-muted-foreground text-sm leading-relaxed">
							<p>
								What started as a small cargo operation in Imphal has grown into
								one of the region&apos;s most trusted logistics partners. Our
								founder&apos;s vision was simple: make shipping reliable,
								transparent, and accessible.
							</p>
							<p>
								Today, we handle thousands of shipments daily, from critical
								medical supplies to enterprise bulk cargo. Our investment in
								technology—from AI-powered tracking to automated
								warehousing—ensures every package reaches its destination safely
								and on time.
							</p>
							<p>
								We&apos;re not just moving cargo; we&apos;re building
								connections that power businesses and communities across the
								globe.
							</p>
						</div>
					</div>
