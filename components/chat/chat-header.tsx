...
import { useChatState, CURRENT_USER_ID, WHATSAPP_CONVERSATION_ID } from "./use-chat-state";
...
export function ChatHeader({
  ...
  const isWhatsAppConversation =
    chatState.state === "conversation" &&
    activeConversation?.id === WHATSAPP_CONVERSATION_ID;
          ...
          {(() => {
            ...
            if (variant === "mobile") {
              if (chatState.state === "conversation") {
                if (isWhatsAppConversation) return "WHATSAPP INVOICES";
