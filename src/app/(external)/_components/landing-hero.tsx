...
function HeroContent() {
	return (
		<div className="flex flex-col items-center text-center space-y-8 max-w-4xl mx-auto z-10 relative px-4">
			...
			>
				Northeast to All India. We combine industrial precision with modern
				tracking for a logistics experience that just works.
			</motion.p>
			...
			>
				<Button
					asChild
					size="lg"
					className="h-12 px-8 rounded-full text-base shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all"
				>
					<Link href="/track">
				...
				<Button
					...
					variant="outline"
					size="lg"
					className="h-12 px-8 rounded-full text-base border-border hover:bg-muted/50"
				>
	...
	return (
		...
		>
			<div className="rounded-xl border border-border bg-card shadow-2xl overflow-hidden relative">
				...
				<div className="absolute -bottom-12 -right-4 md:bottom-8 md:right-8 bg-card border border-border p-4 rounded-xl shadow-xl hidden md:block">
