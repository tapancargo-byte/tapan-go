...
const staticActions: Action[] = [
	...
	},
	{
		...
		perform: () => {
			const ref = window.prompt(
				"Enter shipment reference (e.g. SHP-IMF-2412-001)",
			);
			if (ref) {
	...
	},
	{
		...
		icon: <Search className="h-4 w-4" />,
		perform: () => {
			window.location.href = "/dashboard?status=in_transit";
		},
	},
	{
		id: "filter-delivered",
		...
		icon: <Search className="h-4 w-4" />,
		perform: () => {
			window.location.href = "/dashboard?status=delivered";
		},
	},
	{
		id: "filter-cancelled",
		...
		icon: <Search className="h-4 w-4" />,
		perform: () => {
			window.location.href = "/dashboard?status=cancelled";
		},
	},
	// Theme Section
	{
