        ...
        <Card className='col-span-full xl:col-span-2'>
            <CardHeader className="flex flex-row items-center justify-between pb-8">
                <div className="space-y-1">
                    <CardTitle className="text-base font-medium">Shipment Activity</CardTitle>
                    <CardDescription>Shipments and deliveries for the last 3 months</CardDescription>
                </div>
                <div className="flex items-center gap-2">
                    <Button variant="outline" size="sm" className="h-8">Last 3 months</Button>
                    <Button variant="ghost" size="sm" className="h-8 text-muted-foreground">Last 30 days</Button>
                    <Button variant="ghost" size="sm" className="h-8 text-muted-foreground">Last 7 days</Button>
                </div>
            </CardHeader>
            <CardContent>
