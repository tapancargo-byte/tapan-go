...
const aboutPillars = [
	{
		...
		body: "15+ years moving air and surface cargo between Imphal and New Delhi.",
	},
	{
		icon: MapPinIcon,
		title: "Reliable network & schedules",
		body: "Line-haul and hub timings tuned for predictable transits even in peak season.",
	},
	{
		icon: PackageIcon,
	...
	},
	{
		...
		body: "Escalation playbooks, incident logging and recovery flows keep freight moving when plans change.",
	},
	{
		icon: EmailIcon,
		title: "Documents & compliance",
		body: "Support for GST, e-way bills and PODs so finance and compliance teams stay unblocked.",
	},
	{
		icon: AtomIcon,
		title: "Live visibility for teams",
		body: "Simple public tracking at /track and internal dashboards for ops, customer and partner teams.",
	},
];

export function AboutApps() {
	return (
		<section aria-labelledby="about-tapan-heading" className="py-10 lg:py-12">
