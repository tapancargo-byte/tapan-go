...
export default function DashboardPageLayout({
  ...
  return (
    <div className="flex flex-col relative w-full gap-1 min-h-full">
      <div className="flex items-center lg:items-baseline gap-2.5 md:gap-4 px-4 md:px-6 py-3 md:pb-4 lg:pt-7 ring-2 ring-pop sticky top-header-mobile lg:top-0 bg-background z-10 print:hidden">
        ...
        {header.description && (
          <span className="ml-auto text-xs md:text-sm text-muted-foreground block pr-16 lg:pr-24 text-right">
            {header.description}
          </span>
        )}
      </div>
