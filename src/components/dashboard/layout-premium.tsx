		...
		<div className={cn("min-h-screen relative", className)} {...props}>
			...
			{backgroundEffects && (
				<>
					...
					<div
						className="fixed bottom-20 right-20 w-96 h-96 bg-accent/5 rounded-full blur-3xl animate-float"
							...
							<div className="px-6 py-4">
								<div className="flex items-center justify-between">
									<div className="flex items-center gap-3">
										{header.icon && (
											<div className="flex-shrink-0">{header.icon}</div>
										)}
										<div>
...
interface PageTransitionPremiumProps
	extends React.HTMLAttributes<HTMLDivElement> {
	delay?: number;
}
