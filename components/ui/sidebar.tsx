...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        "flex flex-col gap-2 p-2 bg-sidebar ring-2 ring-sidebar-foreground/[0.025]",
        className
      )}
      {...props}
    />
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col p-2 bg-sidebar ring-2 ring-sidebar-foreground/[0.025]",
        className
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "uppercase text-sidebar-foreground ring-sidebar-ring flex h-10 shrink-0 items-center px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "text-sidebar-foreground pointer-events-none absolute right-1 top-1/2 -translate-y-1/2 flex h-5 min-w-5 items-center justify-center px-1 text-xs font-medium tabular-nums select-none",
