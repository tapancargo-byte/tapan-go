  ...
  "relative overflow-hidden rounded-xl border transition-all duration-300 ease-out",
  {
    variants: {
      variant: {
        ...
        elevated: [
          "bg-card-elevated text-card-foreground border-border/30",
        ...
        premium: [
          "bg-gradient-to-br from-card via-card-elevated to-card",
...
function CardBadge({ 
  ...
  variant?: "default" | "success" | "warning" | "destructive" | "info" | "premium"
}) {
  const badgeVariants = {
    ...
    premium: "bg-gradient-to-r from-primary/10 to-accent/10 text-primary border border-primary/20",
  }
