  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Primary brand colors with sophisticated scale
        primary: {
        ...
        // Enhanced status colors for logistics domain
        success: {
      ...
      boxShadow: {
        ...
        'primary-lg': '0 10px 40px 0 hsl(var(--primary) / 0.2)',
        'success': '0 4px 14px 0 hsl(var(--success) / 0.15)',
        'warning': '0 4px 14px 0 hsl(var(--warning) / 0.15)',
        'destructive': '0 4px 14px 0 hsl(var(--destructive) / 0.15)',
        // Glass morphism shadows
        'glass': '0 8px 32px 0 rgba(31, 38, 135, 0.37)',
        'glass-lg': '0 8px 32px 0 rgba(31, 38, 135, 0.37), 0 0 0 1px rgba(255, 255, 255, 0.05)',
      },
      fontFamily: {
      ...
      keyframes: {
        ...
        "card-hover": {
          ...
          "100%": { transform: "translateY(-2px) scale(1.02)", boxShadow: "0 10px 25px -5px rgb(0 0 0 / 0.1)" },
        },
      },
      animation: {
        ...
        "magic-shimmer-slide": "shimmer-slide var(--speed) ease-in-out infinite alternate",
        "magic-spin-around": "spin-around calc(var(--speed) * 2) infinite linear",
        ...
        "fade-in-stagger-1": "fade-in 0.5s ease-out 0.1s both",
        "fade-in-stagger-2": "fade-in 0.5s ease-out 0.2s both",
        "fade-in-stagger-3": "fade-in 0.5s ease-out 0.3s both",
        "fade-in-stagger-4": "fade-in 0.5s ease-out 0.4s both",
      },
    },
  },
