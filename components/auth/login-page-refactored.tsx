...
import { LoginSuccessToast, useLoginSuccessToast } from "@/components/auth/login-success-toast";
import { ArrowRight, Loader2, Lock, Mail, MapPin, RefreshCw } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const locationDisplay = detectedLocation
        ...
        : selectedScope === 'imphal' ? 'Imphal, India' : 'New Delhi, India';

      const branchDisplay = selectedScope === 'imphal'
        ? 'Imphal (IMF)'
    ...
    <>
      ...
      <div className="min-h-screen w-full bg-background text-foreground flex flex-col relative overflow-hidden selection:bg-primary/20 selection:text-primary">
        ...
        <div className="flex-1 flex items-center justify-center p-4 sm:p-8 relative z-10 pt-24">
          ...
          >
            <Card className="grid lg:grid-cols-2 overflow-hidden rounded-[2.5rem] border-border/40 shadow-2xl bg-card/80 backdrop-blur-xl h-[700px] ring-1 ring-border/10">
              ...
              <div className="relative hidden lg:flex flex-col border-r border-border/10">
                ...
                <div className="absolute bottom-6 left-6 right-6 z-20">
                  <div className="bg-background/20 backdrop-blur-md border border-border/20 p-6 rounded-2xl shadow-xl">
                    <h3 className="text-xl font-bold tracking-tight mb-2 text-foreground">Secure Logistics Platform</h3>
                    <p className="text-muted-foreground text-sm leading-relaxed">
                      Manage your Imphal-Delhi shipments with real-time tracking and enterprise-grade security.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col justify-center p-8 md:p-12 lg:p-16 h-full relative">
                <div className="max-w-md w-full mx-auto space-y-8">
                  ...
                  <div className="space-y-2 text-center lg:text-left">
                    ...
                    <p className="text-muted-foreground">Enter your credentials to access the workspace.</p>
                  </div>
                  ...
                  <p className="text-center text-sm text-muted-foreground">
                    Don't have an account? <Link href="#" className="font-bold text-foreground hover:text-primary transition-colors">Contact Admin</Link>
                  </p>
                </div>
              </div>
            </Card>
