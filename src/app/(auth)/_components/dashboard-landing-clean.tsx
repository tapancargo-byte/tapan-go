						...
						<div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
							...
							>
								<div className="space-y-4">
									...
									<HyperText
										as="h1"
										className="font-extrabold tracking-tight text-primary text-5xl md:text-6xl lg:text-7xl leading-[1.1]"
									>
										{"The Logistics\nSTANDARD."}
									</HyperText>
									<p className="text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed">
										15 years of dedicated service. The OG Imphal ⇄ New Delhi
										operator you can count on.
									</p>
								</div>
								...
								<div className="space-y-4">
									...
									<div>
										...
										<p className="text-sm text-muted-foreground mt-2">
											On-time delivery performance for Imphal ⇄ New Delhi route
											this week.
										</p>
									</div>
								</div>
					...
					<div className="mx-auto max-w-6xl px-6">
						...
						<div className="mt-12 grid md:grid-cols-2 gap-6">
							...
							>
								...
								<p className="text-sm text-muted-foreground leading-relaxed">
									Regular departures from Imphal hub with consolidated freight
									options. Air cargo and road transport available.
								</p>
							</MagicCard>
							<MagicCard
								className="p-6 bg-card/50 backdrop-blur-sm"
							...
							>
								...
								<p className="text-sm text-muted-foreground leading-relaxed">
									Scheduled services from Delhi hub to Imphal. Reliable transit
									times with secure handling throughout.
								</p>
							</MagicCard>
						</div>
					</div>
					...
					<div className="mx-auto max-w-6xl px-6">
						<div className="grid lg:grid-cols-2 gap-12 items-center">
							<div className="space-y-6">
								...
								<MagicCard
									className="p-6 space-y-4 border-transparent bg-card/50 backdrop-blur-sm"
									gradientColor="var(--accent-cool)"
									gradientOpacity={0.15}
								>
										...
										<div className="flex items-start gap-3">
											...
											<div>
												<p className="text-sm font-medium">
													Imphal to New Delhi — Departed
												</p>
												<p className="text-xs text-muted-foreground">
													Line-haul in transit
												</p>
											</div>
										</div>
										<div className="flex items-start gap-3">
							...
							<div className="hidden lg:block">
								<MagicCard
									className="p-8 bg-muted/30 space-y-6 border-transparent"
									...
									<div className="space-y-4">
										...
										<div className="flex items-start gap-3">
											...
											<div>
												...
												<p className="text-xs text-muted-foreground">
													Every shipment handled with care
												</p>
											</div>
										</div>
									</div>
							...
							<div className="relative grid divide-y divide-border/60 md:grid-cols-3 md:divide-y-0 md:divide-x">
								...
								<div className="flex flex-col justify-between">
									...
									<div className="space-y-3 px-5 py-6 text-sm text-muted-foreground">
										...
										<p className="text-xs text-muted-foreground/90">
											For shipment questions and new enquiries, start with our
											AI assistant.
										</p>
										<div className="flex items-center gap-2">
											<Mail className="h-4 w-4" />
											<span className="font-mono text-sm">
												imphal@tapango.logistics
											</span>
										</div>
									</div>
								...
								<div className="flex flex-col justify-between">
									...
									<div className="space-y-3 px-5 py-6 text-sm text-muted-foreground">
										<p className="font-mono text-sm leading-relaxed text-foreground">
											2ND FLOOR FLAT NO 1498/2, GALI NO 3, Wazir Nagar, K.M.
											Pur, New Delhi, Delhi 110003
										</p>
										<p className="text-xs text-muted-foreground/90">
											Use the AI chatbot for quick status checks and FAQs; our
											team will follow up by email when needed.
										</p>
										<div className="flex items-center gap-2">
											<Mail className="h-4 w-4" />
											<span className="font-mono text-sm">
								...
								<div className="flex flex-col justify-between">
									...
									<div className="space-y-3 px-5 py-6 text-sm text-muted-foreground">
										...
										<p className="text-xs text-muted-foreground/90">
											Ideal window for bookings, status checks, and delivery
											coordination across both hubs.
										</p>
									</div>
									<div className="border-t border-border/60 px-5 py-3 text-xs text-muted-foreground">
										For urgent after-hours issues, raise a ticket and our team
										will follow up.
									</div>
								</div>
							</div>
							...
							<div className="relative flex flex-col gap-6 border-t border-border/60 px-5 py-6 md:flex-row md:items-center md:justify-between md:px-8">
								<div className="max-w-md space-y-3">
									...
									<p className="text-sm text-muted-foreground">
										Use the AI assistant for instant answers or create a ticket
										for shipment and invoice escalations.
									</p>
												...
												<div className="mx-auto w-full max-w-3xl">
													<DialogHeader className="px-4 pt-4 pb-2">
														...
														<DialogDescription className="text-xs">
															Ask about Tapan shipments, tracking references,
															and support. For account changes or escalations,
															use the ticket option.
														</DialogDescription>
													</DialogHeader>
											...
											<DialogContent className="p-0 sm:max-w-3xl">
												<div className="mx-auto w-full max-w-3xl">
													<DialogHeader className="px-4 pt-4 pb-2">
														...
														<DialogDescription className="text-xs">
															Create a support ticket for a shipment or invoice.
															Our ops team will follow up over email.
														</DialogDescription>
													</DialogHeader>
													<div className="space-y-4 px-4 pb-4">
														<LandingTicketForm />
			...
			<footer className="border-t border-border bg-background/95 backdrop-blur-sm py-10">
				<div className="mx-auto max-w-5xl px-6">
					<div className="flex flex-col items-center gap-4 text-center">
						<UnifiedLogo className="scale-90 origin-center" />
						<p className="text-sm text-muted-foreground max-w-md">
							Tapan Associate keeps your Northeast cargo network visible and on
							schedule with a unified operations layer.
						</p>
					</div>
					...
					<div className="mt-8 space-y-1 text-center text-xs text-muted-foreground">
						<p>
							{" "}
							{new Date().getFullYear()} Tapan Associate. All rights reserved.
						</p>
						<p>
							Imphal · New Delhi ·{" "}
							<span className="text-foreground/80">Powered by Arra-Core</span>
						</p>
					</div>
				</div>
			</footer>
