...
import type { TicketStatus, UITicket } from "@/features/support/types";
				...
				<table className="w-full text-sm min-w-[800px]">
					<thead className="bg-accent/50 border-b border-pop">
						<tr>
							...
							<th className="px-6 py-3 text-left font-semibold text-right">
								Actions
							</th>
						</tr>
					</thead>
									...
									<td className="px-6 py-4">
										<div className="flex items-center justify-end">
											<select
												value={ticket.status}
												onChange={(e) =>
													onUpdateStatus(ticket, e.target.value as TicketStatus)
												}
